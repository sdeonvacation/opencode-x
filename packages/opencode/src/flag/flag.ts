...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_EXTERNAL_AGENTS =
    OPENCODE_DISABLE_CLAUDE_CODE || truthy("OPENCODE_DISABLE_EXTERNAL_AGENTS")
  export const OPENCODE_DISABLE_EXTERNAL_PLUGIN_AGENTS =
    OPENCODE_DISABLE_CLAUDE_CODE || truthy("OPENCODE_DISABLE_EXTERNAL_PLUGIN_AGENTS")
  ...
  export const OPENCODE_ENABLE_EXA = !falsy("OPENCODE_ENABLE_EXA")
  ...
  export const OPENCODE_EXPERIMENTAL_WORKSPACES = enabledByExperimental("OPENCODE_EXPERIMENTAL_WORKSPACES")
  export const OPENCODE_EXPERIMENTAL_WORKFLOWS = enabledByExperimental("OPENCODE_EXPERIMENTAL_WORKFLOWS")
  export const OPENCODE_EXPERIMENTAL_DREAM = !falsy("OPENCODE_EXPERIMENTAL_DREAM")
