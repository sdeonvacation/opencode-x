...
import { createLoopCommand } from "@tui/command/loop-command"
...
import { createContextCommand } from "@tui/command/context-command"
...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  command.register(() => [
    ...
    createLoopCommand({ dialog, toast, sdk: { url: sdk.url, fetch: sdk.fetch }, route }),
    ...
    createContextCommand({ sdk: { url: sdk.url, fetch: sdk.fetch }, toast, dialog, route }),
