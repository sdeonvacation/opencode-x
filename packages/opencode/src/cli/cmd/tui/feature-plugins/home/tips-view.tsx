...
const TIPS = [
  ...
  "Use {highlight}/sessions{/highlight} or {highlight}Ctrl+X L{/highlight} to list, pin, and continue sessions",
  "Press {highlight}Ctrl+F{/highlight} in the session list to pin a session so it stays at the top",
  "Pinned sessions are bound to {highlight}Ctrl+X 1{/highlight} through {highlight}Ctrl+X 9{/highlight} for one-press switching",
