  ...
  return (
    <>
      ...
      <Show when={props.message.error && props.message.error.name !== "MessageAbortedError"}>
        ...
        >
          <text fg={theme.textMuted}>{props.message.error?.data.message as string}</text>
        </box>
      </Show>
      <Switch>
...
function ReasoningPart(props: { last: boolean; part: ReasoningPart; message: AssistantMessage }) {
  ...
  // OpenAI / Copilot emit `**Title**\n\n<body>` summary blocks. Surface the
...
function TextPart(props: { last: boolean; part: TextPart; message: AssistantMessage }) {
  ...
  //
  // Streaming flicker fix: keep a stable fast-path for the no-thinking case so
  // the single <markdown> element is reused across stream ticks. <For> would
