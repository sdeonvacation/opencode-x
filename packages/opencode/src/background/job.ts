...
import { Cause, Clock, Deferred, Effect, Fiber, Layer, Scope, ServiceMap, SynchronizedRef } from "effect"
...
export class Service extends ServiceMap.Service<Service, Interface>()("@opencode/BackgroundJob") {}
