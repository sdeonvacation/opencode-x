...
| **Branch PR isolation**                     | Built-in — subagent gets own branch, structured diff for review before merge; approve/reject; push-to-bg safe; TTL cleanup                              | Cherry-pick worktree (no review gate)         | Manual worktree orchestration (no built-in review gate) |
