...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/sdeonvacation/opencode-x/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for sdeonvacation/opencode-x...\n")
